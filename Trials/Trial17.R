...
#Inflamatory Episodes
#Generating Set 1
set1 <- subset(dermato_examinations, affected_nonaffected_limb == 1 & frequency_ie == 1 & followup_no == 2)

#Generating Set 2
a <- subset(followup_yoga_details, practicing_yoga == 2 & followup_no == 1)
b <- subset(followup_imld_details, practicing_imld == 1 & followup_no == 1)
c <- subset(followup_compression_details, compression_practice == 2 & followup_no == 1)
d <- subset(dermato_examinations, affected_nonaffected_limb == 1 & frequency_ie == 1 & followup_no == 3)
...
b <- subset(followup_imld_details, practicing_imld == 1 & followup_no == 2)
...
b <- subset(followup_imld_details, practicing_imld == 1 & followup_no == 3)
